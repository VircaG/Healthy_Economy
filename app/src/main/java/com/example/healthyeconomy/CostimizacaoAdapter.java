...
public class CostimizacaoAdapter extends ArrayAdapter {


    public CostimizacaoAdapter(@NonNull Context context, ArrayList<CustomItem> customList) {
    ...
    public View getDropDownView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        if( convertView == null){
            convertView = LayoutInflater.from(getContext()).inflate
                    (R.layout.custom_dropdown_layout,parent,false);
